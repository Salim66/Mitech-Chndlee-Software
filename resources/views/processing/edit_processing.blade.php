            ...
            <div class="col-sm-12">
                <div class="card tab2-card">
                    <div class="card-header">
                        <h5> Edit Processing</h5>
                    </div>
                    <div class="card-body">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade active show" role="tabpanel" aria-labelledby="account-tab">
                                <form class="needs-validation user-add" novalidate="" action="{{ route('update.processing', $data->id) }}" method="POST">
                                    @csrf
                                    @method('PATCH')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control" name="processing_media_name" id="validationCustom0" type="text" required="" value="{{ $data->processing_media_name }}">
                                        </div>
