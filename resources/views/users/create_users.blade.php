                                        ...
                                        <div class="attribute-blocks">
                                            ...
                                            <div class="row mt-2">
                                                ...
                                                <div class="col-xl-9 col-sm-8">
                                                    <div class="form-group m-checkbox-inline mb-0 custom-radio-ml d-flex radio-animated pb-0">
                                                        <label class="d-block mb-0 mr-3" for="edo-ani7">
                                                            <input class="radio_animated" id="edo-ani7" type="radio" name="final_state" value="1">
                                                            Allow
                                                        </label>
                                                        <label class="d-block mb-0" for="edo-ani8">
                                                            <input class="radio_animated" id="edo-ani8" type="radio" name="final_state" value="0" checked="">
                                                            Deny
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row mt-2">
                                                ...
                                                <div class="col-xl-9 col-sm-8">
                                                    <div class="form-group m-checkbox-inline mb-0 custom-radio-ml d-flex radio-animated pb-0">
                                                        <label class="d-block mb-0 mr-3" for="edo-ani7">
                                                            <input class="radio_animated" id="edo-ani7" type="radio" name="country" value="1">
                                                            Allow
                                                        </label>
                                                        <label class="d-block mb-0" for="edo-ani8">
                                                            <input class="radio_animated" id="edo-ani8" type="radio" name="country" value="0" checked="">
                                                            Deny
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row mt-2">
                                                ...
                                                <div class="col-xl-9 col-sm-8">
                                                    <div class="form-group m-checkbox-inline mb-0 custom-radio-ml d-flex radio-animated pb-0">
                                                        <label class="d-block mb-0 mr-3" for="edo-ani7">
                                                            <input class="radio_animated" id="edo-ani7" type="radio" name="processing_media" value="1">
                                                            Allow
                                                        </label>
                                                        <label class="d-block mb-0" for="edo-ani8">
                                                            <input class="radio_animated" id="edo-ani8" type="radio" name="processing_media" value="0" checked="">
                                                            Deny
                                                        </label>
                                                    </div>
                                                </div>
