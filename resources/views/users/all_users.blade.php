...
<div class="page-body">
    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="btn-popup">
                <a href="{{ route('trash.user') }}" class="badge badge-danger float-left ml-4">Trash Users List</a>
                    ...
                    <table id="table_id" class="table table-bordered table-striped">
                        ...
                        @foreach($all_data as $data)
                          <tr>
                            ...
                            <td style="width: 16%">
                                <a title="Edit" href="{{ route('edit.user', $data->id) }}" class="btn btn-outline-info btn-sm"><i class='fa fa-pencil'></i></a>

                                <a title="Delete" href="{{ route('delete.user', $data->id) }}" class="btn btn-sm btn-outline-danger"><i class='fa fa-trash'></i></a>
                            </td>
                          </tr>
                        @endforeach
