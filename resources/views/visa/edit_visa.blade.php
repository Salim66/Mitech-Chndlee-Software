                            ...
                            <div class="tab-pane fade active show" role="tabpanel" aria-labelledby="account-tab">
                                <form class="needs-validation user-add" novalidate="" action="{{ route('update.visa', $data->id) }}" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <select class="form-control digits select2" id="exampleFormControlSelect1" name="tran_id">
                                                ...
                                                <option value="{{ $fmediacl->entry->id }}" {{ ($data->tran_id == $fmediacl->entry->id) ? 'selected' : ''  }}>{{ $fmediacl->entry->name }} | {{ $fmediacl->entry->passport_no }} | {{ $fmediacl->entry->mobile_no }}</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control" name="visa_date" id="validationCustom0" type="date" value="{{ $data->visa_date }}">
                                        </div>
                                        @error('visa_date')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control" name="visa_report" id="validationCustom0" type="text" value="{{ $data->visa_report }}">
                                        </div>
                                        @error('visa_report')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
