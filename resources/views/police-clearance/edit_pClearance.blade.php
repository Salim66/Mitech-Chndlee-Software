                            ...
                            <div class="tab-pane fade active show" id="account" role="tabpanel" aria-labelledby="account-tab">
                                <form class="needs-validation user-add" novalidate="" action="{{ route('update.pClearance', $data->id) }}" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control" name="police_clearance_date" id="validationCustom0" type="date" required="" value="{{ $data->police_clearance_date }}">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control" name="police_clearance_report" id="validationCustom0" type="text" required="" value="{{ $data->police_clearance_report }}">
                                        </div>
